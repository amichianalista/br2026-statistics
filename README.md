...
O app usa `SUPABASE_URL` com `SUPABASE_SERVICE_ROLE_KEY` ou `SUPABASE_SECRET_KEY` para ler os dados pela API do Supabase. Opcionalmente, voce pode definir `SUPABASE_SCHEMA`; se nada for informado, o app usa `public`.
